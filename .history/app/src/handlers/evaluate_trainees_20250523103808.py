            ...
            for index, row in df.iterrows():
                try:
                    ...
                    fields_to_add = {
                        ...
                        "minigame_score": int(evaluation_data['minigame_score']) if evaluation_data['minigame_score'] is not None else None,
                    ...
                    missing_fields = [field for field in required_fields if not fields_to_add.get(field)]
                    if missing_fields:
