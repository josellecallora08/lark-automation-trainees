            ...
            for index, row in df.iterrows():
                try:
                    ...
                    fields_to_add = {
                        ...
                        "status": status_value,  # ✅ safe fallback for potentially strict field
                        "agent": [str(payload["uploaded_by"][0]["id"])],  # ✅ Person field format
                        ...
                        "parent_record_id": payload['record_id'],  # ✅ assuming single-link relation
                        "file": [{
                            "file_token": payload["file"][0]["file_token"],
                            "name": payload["file"][0]["name"]
                        }],
                        "trainer": [str(payload["uploaded_by"][0]["id"])],
