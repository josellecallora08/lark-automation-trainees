            ...
            for index, row in df.iterrows():
                try:
                    ...
                    fields = {
                        ...
                        'name': trainee['name'],
                        'final_score': trainee['final_score'],
                        'engagement_score': trainee['engagement_score'],
                        'knowledge_score': trainee['knowledge_score'],
                        'critical_thinking_score': trainee['critical_thinking_score'],
                        'minigame_score': trainee['minigame_score'],
                        'parent_record_id': parent_record_id,
                        'file': [{
                            'file_token': file_token,
                            'name': file_name,
                        }],
                        'user_rating': float(trainee['final_score']),
                        # 'agent': trainee['agent'],       # 🔴 TEMPORARILY REMOVED
                        # 'trainer': trainee['trainer'],   # 🔴 TEMPORARILY REMOVED
                    }
