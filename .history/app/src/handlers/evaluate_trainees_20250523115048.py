            ...
            for index, row in df.iterrows():
                try:
                    ...
                    fields_to_add = {
                        ...
                        "status": status_value,  # still 'Passed' or 'Pending'
                      "agent": [{"email": payload["uploaded_by"][0]["email"]}],  # ✅ CORRECT FORMAT
    "trainer": [{"email": payload["uploaded_by"][0]["email"]}],  # ✅ CORRECT FORMAT
                        ...
                        "trainer": [payload["uploaded_by"][0]["email"]],  # ✅ you might want to change this too
